...
public class LEDCubeManager {
    ...
    @Getter
    private static File dataDirectory = OperatingSystem.getDataDirectory("ledcubemanager");
    @Getter
    ...
    @Getter
    private static String portHandlerName = "SerialPortHandler";
    @Getter
    private static String ledManagerName = null;
    @Getter
    private static String[] ledManagerArgs = new String[0];
    @Getter
    ...
    private void runGameLoop() throws LWJGLException, InterruptedException {
        ...
        this.update();
        if (Display.isActive() || (frame.isVisible() && frame.getState() != Frame.ICONIFIED) || frameServer.numClients > 0)
            this.render();
